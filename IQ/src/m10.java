...
public class m10 implements ActionListener
{
    JFrame jfm;
    ...
    public int score;
    long StartTime,EndTime,NitTime,GotTime,xx;
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(rn1*rn==n)
        {
            ...
            try {
                score ob = new score(xx+100);
            } catch (Exception ex) {
                Logger.getLogger(m10.class.getName()).log(Level.SEVERE, null, ex);
            }
