...
public class v2a implements ActionListener
{
    JFrame jfm;
    JLabel j1;
    ...
    v2a(int s,long t)
    {
        ...
        j1= new JLabel();
        j1.setText("<html> <p style=\" text-align:center;color:purple;font-size:20px; \">How Many Fruits Have You Seen there(Hint: into Google)</p> </html>");
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource() == b1)
        {
         v3 ob= new v3(score+100,NitTime);
