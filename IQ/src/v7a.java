...
public class v7a implements ActionListener
{
    JFrame jfm;
    JLabel j1;
    ...
    v7a(int s,long t)
    {
        ...
        j1= new JLabel();
        j1.setText("<html> <p style=\" text-align:center;color:purple;font-size:20px; \">What is the color of Third(pink) Minion's eye?</p> </html>");
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(ae.getSource() == b4)
        {
            ...
            v8 ob= new v8(score+100,NitTime);
            jfm.setVisible(false);
        }   	
