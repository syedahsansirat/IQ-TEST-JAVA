...
public class v5a implements ActionListener
{
    JFrame jfm;
    JLabel j1;
    ...
    v5a(int s,long t)
    {
        ...
        j1= new JLabel();
        j1.setText("<html> <p style=\" text-align:center;color:purple;font-size:20px; \">How Many Empty Block/Blocks are there?</p> </html>");
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(ae.getSource() == b3)
        {
            ...
            v6 ob= new v6(score+100,NitTime);                          
            jfm.setVisible(false);
        } 
