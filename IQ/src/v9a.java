...
public class v9a implements ActionListener
{
    JFrame jfm;
    JLabel j1;
    ...
    v9a(int s,long t)
    {
        ...
        j1= new JLabel();
        j1.setText("<html> <p style=\" text-align:center;color:purple;font-size:20px; \">How Many Android Robot are There?</p> </html>");
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource() == b1)
        {
            ...
            v99 ob= new v99(score+100,NitTime);
