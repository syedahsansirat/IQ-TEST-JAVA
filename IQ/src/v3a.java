...
public class v3a implements ActionListener
{
    JFrame jfm;
    JLabel j1;
    ...
    v3a(int s,long t)
    {
        ...
        j1= new JLabel();
        j1.setText("<html> <p style=\" text-align:center;color:purple;font-size:20px; \">What is the Color of Block Where the King Stands?</p> </html>");
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        {
           	v4 ob= new v4(score+100,NitTime);
