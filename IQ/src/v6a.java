...
public class v6a implements ActionListener
{
    JFrame jfm;
    JLabel j1;
    ...
    v6a(int s,long t)
    {
        ...
        j1= new JLabel();
        j1.setText("<html> <p style=\" text-align:center;color:purple;font-size:20px; \">How Many  Bangladeshi Flags are in there?</p> </html>");
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(ae.getSource() == b2)
        {
            ...
            v7 ob= new v7(score+100,NitTime); 
            jfm.setVisible(false);
